...
section .data							
	...
	number2	dq	100000000	; show the arithmetic
                            ; Números grandes puestos para ver cómo IMUL pone medio resultado en RDX y medio en RAX
...
; multiply-------------------------------------------------------------------
    mov	rax, [number1]
    MOV RDX, 5                  ; Para ver qué hace IMUL con RDX
                                ; (RDX contiene los 64 bits superiores y RAX los 64 inferiores de la operación IMUL)
